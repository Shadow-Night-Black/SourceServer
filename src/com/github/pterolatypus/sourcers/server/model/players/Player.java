...
import com.github.pterolatypus.sourcers.server.model.npcs.NPC;
import com.github.pterolatypus.sourcers.server.model.npcs.NPCHandler;
import com.github.pterolatypus.sourcers.server.util.ISAACRandomGen;
...
public abstract class Player {
	...
	protected void appendPlayerAppearance(Stream str) {
		...
		if (!ItemO.isFullBody(playerEquipment[playerChest])) {
		...
		if (!ItemO.isFullHelm(playerEquipment[playerHat])
				&& !ItemO.isFullMask(playerEquipment[playerHat])) {
